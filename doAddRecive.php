...
<html>
    ...
    <body>
        ...
        <div class="modal fade" tabindex="-1" role="dialog"  id="myModal" name="myModal">
          ...
          <form class="form-horizontal" role="post" method="post" action="index.php?viewName=recive_product">
		...
		<script type="text/javascript">
           ...
           <?php
		   		if($id  == "" || $quantity == "0" || $quantity == ""){
					...
					$product_refID = $obj->insert_product_recive($data);
					if ($product_refID == false) {
						redirect("errorAddRecive.php.php");
						echo ($product_refID );
					} else {                          
						$obj->insert_product_detail_recive($data, $_REQUEST["id"]);
