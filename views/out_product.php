...
<div class="container">
<legend>
    <h3><label class="label label-warning">เบิกสินค้า</label></h3>
</legend>	
 <form class="form-horizontal" role="form" method="post" action="?viewName=out_product">
            <div class="row">
                                ...
                                if ($rows != false) {
                                    ...
                                    foreach ($rows as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="index.php?viewName=out_product&id=<?= $row["id"] ?>&name=" class="btn btn-sm btn-primary">
                                                    เลืิอก
                                                </a>
                                            </td>
                                        </tr>
    ...
    <form action="doAddOut.php" method="post" class="form form-horizontal">
        <fieldset>          
            <div class="row">
				 <div class="form-group col-md-12">
