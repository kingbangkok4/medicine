...
<html>
    ...
    <div class="row">
    	<div class="col-md-12">
   		  <h3 class="form-signin-heading" style="margin-left:35px;text-align:center;color:#333"; ><label class="">ระบบสินค้าคงคลังยาและเวชภัณฑ์</label>
                <br /><br />
   		    <img src="images/logo.png" width="268" height="155"></h3>
                <br />
        </div>
    </div>
        <div class="container">
